...
public class ExceptionsHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<ExceptionResponse> handleSecurity(BusinessException businessException){
    ...
    protected ResponseEntity<ExceptionResponse> handleSecurity(NotFoundException notFoundException){
